...
class SeeReports {
    seeReports(username, index, offset) {
        return __awaiter(this, void 0, void 0, function* () {
            let response;
            let reports = [];
            // Get groups
            try {
                reports = yield Report_model_1.default.find({ 'reportingUser.username': username }, { _id: 0, __v: 0 }, { skip: offset, limit: index });
            }
            catch (_a) {
                response = {
...
exports.default = new SeeReports();
